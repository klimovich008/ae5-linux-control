...
1. **Never set the PipeWire sink above 20%.** Start acoustic tests at 5%.
   (A PreToolUse hook in `.claude/settings.json` enforces this for shell
   commands — do not work around it.)
