...
The active speaker selection converted to a native profile containing 20 ALSA
...
report. An aggregate SHA-256 of every file below the mounted Creative and
Creative_Technology_Ltd trees was identical before and after both conversions.
